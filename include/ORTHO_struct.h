/*------------------------------------------------------------------------
 *  ORTHO_struct.h - define data structures for ORTHO forward problem 
 *
 *  D. Koehn
...
struct mat{
   float   ***rho;
   float   ***c1111, ***c1122, ***c1133, ***c2222, ***c2233, ***c3333;
   float   ***c2323, ***c1313, ***c1212;
   float   ***taus, ***taup, *eta;
   float   ***rhoijpkp, ***rhoipjkp, ***rhoipjpk;
   float   ***c2323h, ***c1313h, ***c1212h;
