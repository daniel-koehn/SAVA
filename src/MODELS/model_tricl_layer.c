/*------------------------------------------------------------------------
 *   Anisotropic (triclinic) layered model
 *
 *   D. Köhn
 *  ----------------------------------------------------------------------*/
	...
	for (i=1;i<=NX[0];i++){
		for (j=1;j<=NX[1];j++){
			for (k=1;k<=NX[2];k++){
				...
				c1111t = c1111ortho2;	/* (C11) */
				c1122t = c1122ortho2;	/* (C12) */
				c1133t = c1133ortho2;	/* (C13) */
				c2222t = c2222ortho2;	/* (C22) */
				c2233t = c2233ortho2;	/* (C23) */
				c3333t = c3333ortho2;	/* (C33) */

				c1123t = c1123ortho2;	/* (C14) */
				c1113t = c1113ortho2;	/* (C15) */
				c1112t = c1112ortho2;	/* (C16) */
				c2223t = c2223ortho2;	/* (C24) */
				c1322t = c1322ortho2;	/* (C25) */
				c1222t = c1222ortho2;	/* (C26) */
				c2333t = c2333ortho2;	/* (C34) */
				c1333t = c1333ortho2;	/* (C35) */
				c1233t = c1233ortho2;	/* (C36) */

				c2323t = c2323ortho2;	/* (C44) */
				c1323t = c1323ortho2;	/* (C45) */
				c1223t = c1223ortho2;	/* (C46) */
				c1313t = c1313ortho2;	/* (C55) */
				c1213t = c1213ortho2;	/* (C56) */
				c1212t = c1212ortho2;	/* (C66) */
