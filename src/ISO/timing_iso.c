...
//		fp = fopen(T_FILE,"w");
//		fprintf(fp," %% timestep \t  velocity update [s] \t stress update [s] \t PML velocity update [s] \t PML stress update [s] \t velocity exchange [s] \t stress exchange [s]\t total [s]\n");
//		for (nt=1;nt<=NT;nt++)
//			fprintf(fp," %d \t\t %e \t\t %e \t\t %e \t\t %e \t\t %e \t\t %e \t\t %e \n", 
//				nt, time_v_update[nt],time_s_update[nt],time_v_pml_update[nt],time_s_pml_update[nt],time_s_exchange[nt],time_v_exchange[nt], time_timestep[nt]);
//		fclose(fp);
//	}
}
