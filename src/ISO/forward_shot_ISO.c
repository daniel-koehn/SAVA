/*  -------------------------------------------
 *   Isotropic elastic forward modelling for one shot
 *
 *
 *   D. Koehn
 *   Kiel, 20.10.2017
...
void forward_shot_ISO(struct wave *wave, struct pmls *pmls, struct mat *mat, struct geom *geom, struct mpi *mpi, 
