/*
 *  SAVA_ORTHO: 3D parallel orthorhombic time domain FD modelling, 
 *  FWI and RTM code  
 *
 *  Daniel Koehn
 *  Kiel, 14/08/2017
 *
 *  The original forward modelling code fd3dortho was developed by Olaf Hellwig, 
...
int main(int argc, char **argv){
	...
	/* 3D orthorhombic visco-elastic forward problem */
	//if(MODE==0){
	   FD_ORTHO();
	//}

	/* 3D orthorhombic visco-elastic Full Waveform Inversion */
	/*if(MODE==1){
	   FWI_ORTHO();
	}*/

        /* 3D orthorhombic visco-elastic Reverse Time Migration */
	/*if(MODE==2){
	   RTM_ORTHO();
	}*/
