/*
 *  SAVA_ISO: 3D parallel isotropic viscoelastic time domain FD modelling, 
 *  FWI and RTM code  
 *
 *  Daniel Koehn
 *  Kiel, 14/08/2017
 *
 *  The original forward modelling code fd3dps was developed by Olaf Hellwig:
 *  ------------------------------------------------------------------------
 *  Dr. Olaf Hellwig
...
int main(int argc, char **argv){
	...
	/* 3D isotropic visco-elastic forward problem */
	//if(MODE==0){
	   FD_ISO();
	//}

	/* 3D isotropic visco-elastic Full Waveform Inversion */
	/*if(MODE==1){
	   FWI_AC();
	}*/

        /* 3D isotropic visco-elastic Reverse Time Migration */
	/*if(MODE==2){
	   RTM_AC();
	}*/
