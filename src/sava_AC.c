/*
 *  SAVA_AC: 3D parallel viscoacoustic time domain FD modelling, 
 *  FWI and RTM code  
 *
 *  Daniel Koehn
 *  Kiel, 14/08/2017
 *
 *  The original forward modelling code fd3dp was developed by Olaf Hellwig:
 *  ------------------------------------------------------------------------
 *  Dr. Olaf Hellwig
...
int main(int argc, char **argv){
	...
	/* 3D visco-acoustic forward problem */
	//if(MODE==0){
	   FD_AC();
	//}

	/* 3D visco-acoustic Full Waveform Inversion */
	/*if(MODE==1){
	   FWI_AC();
	}*/

        /* 3D visco-acoustic Reverse Time Migration */
	/*if(MODE==2){
	   RTM_AC();
	}*/
