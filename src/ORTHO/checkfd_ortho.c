...
//				eigenvalue(g,e,3);
				...
				for (l=1;l<nphi;l++){
					...
					for (m=1;m<=ntheta;m++){
						...
						/* Kelvin-Christoffel matrix */
//						g[1][1] = c1111[i][j][k]*l11 + c1212[i][j][k]*l22 + g11;
//						g[2][2] = c1212[i][j][k]*l11 + c2222[i][j][k]*l22 + g22;
//						g[3][3] = c1313[i][j][k]*l11 + c2323[i][j][k]*l22 + g33;
//						g[2][3] = c23*l23;
//						g[1][3] = c13*l13;
//						g[1][2] = c12*l12;
						g[1] = c1111[i][j][k]*l11 + c1212[i][j][k]*l22 + g11;
						g[2] = c1212[i][j][k]*l11 + c2222[i][j][k]*l22 + g22;
						g[3] = c1313[i][j][k]*l11 + c2323[i][j][k]*l22 + g33;
						g[4] = c23*l23;
						g[5] = c13*l13;
						g[6] = c12*l12;
